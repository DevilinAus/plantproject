...
def get_chart_data():
    ...
    # Access the 'timeframe' field sent by the client
    timeframe = data.get("timeframe")
    print("Received timeframe:", timeframe)  # Will print: Received timeframe: 1d
...
#         cursor.execute(
#             "INSERT INTO moist (date_time, wetness, box_colour) VALUES (?, ?, ?)",
#             (epoch_time, last_generated, box_colour),
#         )
